...
use crate::middleware::{RateLimiter, IpBlocklist};
...
impl AppState {
    pub fn new(
        ...
        let config = crate::config::load_config().unwrap_or_else(|_| {
            Config {
        ...
        Self { db, ml_client, ml_base_url, ml_model_path, ml_infer_cmd, ml_embed_cmd, config, rate_limiter, ip_blacklist, ws_manager }
    }
